...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('reservation_status', sa.String(length=20), server_default='pre_reserved', nullable=False),
    ...
    op.create_index('idx_reservation_dates', 'reservations', ['accommodation_id', 'check_in', 'check_out'])
