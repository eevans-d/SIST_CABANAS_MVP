    ...
    async with SessionLocal() as session:
        ...
        cabana_familiar = Accommodation(
            ...
            photos={
                ...
                "interior": [
                    "https://example.com/cabana1/living.jpg",
                    "https://example.com/cabana1/cocina.jpg",
                ],
                "exterior": [
                    "https://example.com/cabana1/exterior1.jpg",
                    "https://example.com/cabana1/exterior2.jpg",
                ],
            },
            location={
        ...
        depto_centrico = Accommodation(
            ...
            photos={
                ...
                "interior": [
                    "https://example.com/depto1/living.jpg",
                    "https://example.com/depto1/dormitorio.jpg",
                ],
        ...
        casa_completa = Accommodation(
            ...
            photos={
                ...
                "interior": [
                    "https://example.com/casa1/living.jpg",
                    "https://example.com/casa1/cocina.jpg",
                    "https://example.com/casa1/dormitorio1.jpg",
                ],
                "exterior": [
                    "https://example.com/casa1/jardin.jpg",
                    "https://example.com/casa1/piscina.jpg",
                    "https://example.com/casa1/quincho.jpg",
                ],
            },
            location={
            ...
            policies={
                ...
                "deposito": 35,
                "reglas": [
                    "Eventos permitidos previo acuerdo",
                    "Mascotas bienvenidas",
                    "Máximo 8 personas",
                    "Cuidar la piscina y jardín",
                ],
            },
            ical_export_token=str(uuid.uuid4()),
            ical_import_urls=[],
