...
import pytest
from app.services.email import EMAIL_SENT, EmailService
...
async def test_all_email_types_logged_correctly():
    ...
    test_cases = [
        (
            "prereservation",
            service.send_prereservation_confirmation,
            {
                "guest_email": "test@example.com",
                "guest_name": "Test",
        ...
        (
            "confirmed",
            service.send_reservation_confirmed,
            {
                "guest_email": "test@example.com",
                "guest_name": "Test",
        ...
        (
            "expired",
            service.send_reservation_expired,
            {
                "guest_email": "test@example.com",
                "guest_name": "Test",
